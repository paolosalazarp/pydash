...
epsilon = 0.01   # tasa de exploración
episodes = 100
max_steps = 5000
reward_log = []

# Visualización (define desde qué episodio se quiere ver el juego)
show_from_episode = [1,25,50,75,99]  # Cambia a None si no quieres ver ningún episodio
...
for ep in range(episodes):
    ...
    render = show_from_episode is not None and ep in show_from_episode
    counter = 0
    r0 = 0
